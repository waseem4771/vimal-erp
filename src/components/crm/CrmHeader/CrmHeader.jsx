...
import { FiTrendingUp, FiActivity, FiRefreshCw } from 'react-icons/fi';

/**
 * Enterprise CrmHeader - EXECUTIVE ELITE EDITION
 * Fix: Changed heading to h2 for professional scale. ✅
 ...
 */
export default function CrmHeader({ selectedSbuId, onRefresh }) {
  ...
  const titleStyle = {
    fontSize: isMobile ? '18px' : '26px', // Balanced h2 scale
    fontWeight: '950',
    color: '#0f172a',
  ...
  const syncBtnStyle = {
    ...
    color: '#9333ea', // Purple theme for Marketing/CRM
    ...
    <div style={containerStyle}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', paddingLeft: '2px' }}>
          ...
          {/* Main Heading h2 ✅ */}
          <h2 style={titleStyle}>Marketing Intelligence</h2>
          
          <div style={subLabelStyle}>
            {/* Real CRM Icon ✅ */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                <FiTrendingUp style={{ color: '#9333ea', fontSize: isMobile ? '12px' : '14px' }} />
                <span>Unit: <span style={{ color: '#9333ea', fontWeight: '950' }}>ID {selectedSbuId}</span></span>
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                ...
                <span style={{ color: '#10b981' }}>Lead Tracking Active</span>
            </div>
          </div>
        </div>
      </div>
