...
// Professional Icons for Cash Flow ✅
import { FiActivity, FiTrendingUp, FiDownload, FiPrinter } from 'react-icons/fi';

/**
 * Enterprise CashFlowHeader - EXECUTIVE ELITE EDITION
 ...
 */
export default function CashFlowHeader({ selectedSbuId, onExport, onPrint, loading, hasData }) {
    ...
    <div style={containerStyle}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', paddingLeft: '2px', textAlign: 'left' }}>
          <h2 style={titleStyle}>Cash Flow Statement</h2>
          
          <div style={subLabelStyle}>
            {/* Liquidity Icon ✅ */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                <FiTrendingUp style={{ color: '#0ea5e9', fontSize: isMobile ? '12px' : '14px' }} />
                <span>Unit: <span style={{ color: '#0ea5e9', fontWeight: '950' }}>ID {selectedSbuId}</span></span>
            </div>
            
            <span style={{ color: '#e2e8f0' }}>|</span>

            {/* Real-time Monitor Icon ✅ */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                <FiActivity className="animate-pulse" style={{ color: '#10b981', fontSize: isMobile ? '12px' : '14px' }} />
                <span style={{ color: '#10b981' }}>Liquidity Monitoring</span>
            </div>
          </div>
        </div>
      </div>
